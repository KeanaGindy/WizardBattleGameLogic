    ...
    public static void main(String[] args) {
        ...
        for (int round = 1; round < 9; round++) {
            ...
            if (GamePlay.player.health > 0) {
                System.out.println("\t\tYou gained " + GamePlay.play() + " experience "
        ...
        for (int round = 1; round < 9; round++) {
            ...
            if (gamePlay1.player.health > 0) {
                System.out.println("\t\tYou gained " + gamePlay1.play() + " experience "
                        + "points during this round!!!!\n");
            }
            if (gamePlay1.player.health <= 0) {
                System.out.println("\t\tBut your player died. Better luck next time.\n\n");
        ...
        for (int round = 1; round < 9; round++) {
            ...
            if (gamePlay2.player.health > 0) {
                System.out.println("\t\tYou gained " + gamePlay2.play() + " experience points"
                        + " during this round!!!!\n");
            }
            if (gamePlay2.player.health <= 0) {
                System.out.println("\t\tBut your player died. Better luck next time.\n\n");
