...
public class GamePlay implements GamePlayInterface {
    ...
    /**
     * Function to add experience points for attacking character and returning
     * the damage the character tries to deal.
    ...
    /**
     * Function to add experience points for attacked character as well as 
     * update their health based on the attack and
     * their protection.
     * If their protection is higher than the blowDamage then the character will
     * heal by half of that difference they will also gain
     * the full difference as experience
     * If their protection is lower or equal than the blowDamage then the 
     * character will take half the difference as experience and the health will be reduced
    ...
    /**
     * Function to level up characters correctly, if they have enough points to 
     * do so.
     ...
     * versions in the .class files in the cls
     * directory. So you need to Blackbox test this method based on the description 
     * you get here. As you see the method returns void, 
     * so no return type. You need to come up with a way to still test if this
     ...
     * - The player will attack each opponent once, and each opponent
     *  will attack the player once.
     * - The player will just iterate through the list of opponents in 
     * the order they are in
     * - The attack from an opponent and the attack on the same opponent happen 
     * right after one another. The order in
     * which the attacks happen are based on the speed of the opponent and player. 
     ...
     * rounded up to the next integer in experience points. Your player then 
     * moves onto the next opponent.
     * - The attack and levelUp are in separate methods (for whitebox testing in assignment 
     * 3 you can assume that these methods work 
